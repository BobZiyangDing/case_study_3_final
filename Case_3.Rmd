...
```{r voting state plot, echo=F, message=F}
...
```{r winning probability, include=F}
...
```{r prob senator remains in control of republican}
#need to change!!
#in other states: Biden: 232-13, Trump: 306-29-18-15-10-20
# c_ex_votes <- 232-13; t_ex_votes <- 306-29-18-15-10-20
total_rep_senate <-  ( { senator_sims>50 } * 2) %>% rowSums() + 2
hist(total_rep_senate)


sum( rowMeans(senator_sims* 48/50 + 2)>50   ) / dim(senator_sims)[1]
```
