...
```{r eda-methods, echo=FALSE, fig.cap="Figure A: Poll Methodology", fig.align="center", fig.width=9, fig.height=4}
...
```{r eda-state, echo=FALSE, fig.cap="Figure B: Polls State Distribution",fig.align="center", fig.width=12, fig.height=4}
...
```{r eda-house-senate-polls, echo=FALSE, fig.cap="Figure C: Candidate Party Polls",fig.align="center", fig.width=8, fig.height=3}
...
```{r eda-biden, echo=FALSE, fig.cap="Figure D: Biden Margin", fig.align='center', fig.width=4, fig.height=3}
